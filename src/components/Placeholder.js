      ...
      <div className="App">
        <Draggable>
          <div className="signatureContainer card place-card shadow box ">
            <span className="d-flex x-mark mx-2  fs-3 p-1">
              {" "}
              <span className="fs-6">Sign on Document</span>{" "}
              <i
            ...
            <p className="sig py-1 mx-2">
              Please in this space provided below to confirm your signature
            </p>
            <SignatureCanvas
              penColor="#000"
              canvasProps={{
            ...
            <div className="radio-sig d-flex">
              ...
              <label for="signature" id="label">
                Apply this signature for require places on document
              </label>
            </div>

            <div className="card-body cb   d-flex   ">
              <span class="btn but" onClick={save}>
                {" "}
                Confirm Signature{" "}
              </span>
